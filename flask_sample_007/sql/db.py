...
if __name__ == "__main__":
    ...
    # print(DB.insertOne("INSERT INTO IS601_Sample (name, val) VALUES (%s, %s)",'key', 'value'))
    # data = [("name", "bob"), ("age",50)]
    # print(DB.insertMany("INSERT INTO IS601_Sample (name, val) VALUES (%s, %s)", data))

    db = DB.getDB()
    cur = db.cursor()
    cur.execute("UPDATE IS601_Sample SET val = %s WHERE name = %s", ("matt", "name"))
    db.commit()
    cur.close()